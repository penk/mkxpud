...
NPError Private_GetValue(void *instance, NPPVariable variable, void *result)
{
...
NPError
NP_Initialize_OLD(NPNetscapeFuncs* nsTable, NPPluginFuncs* pluginFuncs)
{
    NPError err = NPERR_NO_ERROR;
